...
namespace RazorPages_CRUD_NO_EntityFramework.Pages
{
    public class EditModel : PageModel
    {
        ...
        public IActionResult OnPostAsync(int _id)
        {
            ...
            using (SqlConnection con = new SqlConnection(cs))
            {
                string req = "update Etudiant set nom ='" + ListeEtudiants.nom.ToString() + "',email='" + ListeEtudiants.email.ToString() + "',datenaissance='" + Convert.ToDateTime(ListeEtudiants.datenaissance) + "',sexe='" + ListeEtudiants.sexe.ToString() + "' where id=" + _id ;
